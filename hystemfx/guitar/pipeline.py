...
class GuitarPipeline:
    ...
    def process(
        ...
        1. Demucs를 사용하여 믹스에서 기타 트랙을 분리합니다.
        ...
        :return: 처리된 기타 오디오 배열, 또는 모든 스템이 포함된 딕셔너리
        """
...
def process_guitar_from_mix(
    ...
    **effect_params
    ...
    """
    [편의 함수] 믹스 오디오에서 기타를 분리하고 이펙트를 적용합니다.
    
    GuitarPipeline 클래스를 인스턴스화하지 않고 빠르게 처리하고 싶을 때 사용하세요.
