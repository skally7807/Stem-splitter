...
class GuitarSeparator(DemucsSeparator):
    """
    기타 분리 전용 클래스
    DemucsSeparator를 상속받아 'guitar' 스템을 추출합니다.
    """
    ...
    def separate(
        ...
        Returns:
            np.ndarray: 분리된 기타 오디오 (return_all_stems=False)
...
def separate_guitar(
    ...
    Returns:
        np.ndarray: 분리된 기타 오디오
    """
    separator = GuitarSeparator(device=device)
